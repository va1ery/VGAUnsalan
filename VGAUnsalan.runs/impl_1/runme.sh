...
HD_PWD='C:/FPGAProjects/VGAUnsalan/VGAUnsalan.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_top_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGA_top_module.tcl -notrace
