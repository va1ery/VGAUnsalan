...
HD_PWD='C:/FPGAProjects/VGAUnsalan/VGAUnsalan.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_top_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_top_module.tcl
